...
However, you can configure the table identifier generator using the https://javaee.github.io/javaee-spec/javadocs/jakarta.persistence.TableGenerator.html[`@TableGenerator`] annotation.
