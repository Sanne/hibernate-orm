...
JPA only supports entity eviction through the https://javaee.github.io/javaee-spec/javadocs/javax/persistence/Cache.html[`jakarta.persistence.Cache`] interface:
