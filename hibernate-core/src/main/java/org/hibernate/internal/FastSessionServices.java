...
final class FastSessionServices {
	...
	final List<SessionEventListener> defaultSessionEventListeners;
	...
	FastSessionServices(SessionFactoryImpl sf) {
		...
		this.defaultSessionEventListeners = Collections.unmodifiableList( sessionFactoryOptions.getBaselineSessionEventsListenerBuilder().buildBaselineList() );
	}
