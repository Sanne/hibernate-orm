...
public class DefaultCacheKeysFactory {
	...
	public static CollectionCacheKey greateCollectionKey(Serializable id, CollectionPersister persister, SessionFactoryImplementor factory, String tenantIdentifier) {
