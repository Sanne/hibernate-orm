 ...
 * for the case in which the ID is not an array and the tenantId is undefined.
 * The goal of this specialization is to be more efficient for this most common
 * scenario, and save memory.
